...
const StaggeredMenu = ({
    ...
    return (
        <div
            className={`sm-scope z-[70] pointer-events-none ${isFixed ? 'fixed top-0 left-0 w-screen h-screen overflow-hidden' : 'w-full h-full'}`}
        >
            <div
                className={
                ...
                style={{
                    ...
                    '--sm-bg': darkMode ? '#000000' : '#ffffff',
                    '--sm-text': darkMode ? '#ffffff' : '#000000'
                }}
                data-position={position}
                data-open={open || undefined}
            >
                {/* ... (prelayers omitted, no change needed if not touching) ... */}
                <div
                    ref={preLayersRef}
                ...
                <aside
                    ...
                    ref={panelRef}
                    className="staggered-menu-panel absolute top-0 right-0 h-full flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto shadow-2xl transition-colors duration-500"
                    style={{ WebkitBackdropFilter: 'blur(12px)', backgroundColor: 'var(--sm-bg)' }}
                    aria-hidden={!open}
                >
